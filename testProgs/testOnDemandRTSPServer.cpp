...
int main(int argc, char **argv) {
  ...
  if (0) {
    ...
    MPEG1or2FileServerDemux *demux
        = MPEG1or2FileServerDemux::createNew(*env,
                                             inputFileName,
                                             reuseFirstSource);
...
//#define INTERLEAVE_ADUS 1
  ...
  if (0) {
    ...
    MatroskaFileServerDemux::createNew(*env,
                                       inputFileName,
                                       onMatroskaDemuxCreation,
                                       NULL);
  ...
  if (0) {
    ...
    newDemuxWatchVariable = 0;
    OggFileServerDemux::createNew(*env,
                                  inputFileName,
                                  onOggDemuxCreation,
                                  NULL);
    env->taskScheduler().doEventLoop(&newDemuxWatchVariable);
  ...
  if (0) {
    ...
    *env << "\n\"" << streamName
         << "\" stream, from a UDP Transport Stream input source \n\t(";
